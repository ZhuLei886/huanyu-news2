...
public class ArticleController {
    ...
    public ModelAndView xwsaveArticle(String t_article_title_1,
        ...
        mapper.xwinsertArticle(t_article_title_1,t_article_title_2,t_article_title_3,t_article_source,t_article_author,t_article_create_date,t_article_img1,t_article_img2,t_article_img3,t_article_img4,t_article_img5,t_article_document,t_article_classification,t_classification_code,0);
        List article=mapper.getAllArticles();
        mv.addObject("allarticle",article);
        mv.setViewName("/app2/xw_article.html");
        return mv;
